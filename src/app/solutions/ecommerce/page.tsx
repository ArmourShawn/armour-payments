...
export default function EcommercePOSPage() {
  return (
    <Container className="mt-16 sm:mt-32">
      <header className="max-w-2xl">
        ...
        <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
          Secure online payment solutions for digital businesses.
        </p>
      </header>
      <Prose className="mt-8">
        ...
        <div className="mt-8">
          <h2>Why Choose Armour Payments for E-commerce?</h2>
          <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="mt-1 text-sm text-gray-500">Fast implementation and integration.</p>
              </div>
            </div>
          </div>
        </div>
